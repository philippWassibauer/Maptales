...
urlpatterns = patterns('',
    # blog post
    url(r'^post/(?P<username>[-\w]+)/(?P<slug>[-\w]+)/$', 'blog.views.post', name='blog_post'),
    ...
    url(r'^post-selector-list/(?P<username>\w+)/$', 'blog.views.post_selector_list', name='post_selector_list'),
