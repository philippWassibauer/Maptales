...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Image.location_name'
        db.delete_column('photos_image', 'location_name')
        
        # Deleting field 'Image.location'
        db.delete_column('photos_image', 'location')
        
    
    
    def backwards(self, orm):
        
        # Adding field 'Image.location_name'
        db.add_column('photos_image', 'location_name', orm['photos.image:location_name'])
        
        # Adding field 'Image.location'
        db.add_column('photos_image', 'location', orm['photos.image:location'])
