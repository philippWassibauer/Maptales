...
class ContactForm(forms.Form):
    ...
    def save(self, fail_silently=False):
        send_mail(fail_silently=True, from_email=self.cleaned_data['email'], subject="Kontaktaufnahme von: "+self.cleaned_data['name'],
                                                message = self.cleaned_data['message'], recipient_list = self.recipient_list)
