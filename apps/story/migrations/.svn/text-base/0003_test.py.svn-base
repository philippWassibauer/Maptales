...
class Migration:
    ...
    def forwards(self, orm):
        # Changing field 'Story.privacy'
        # (to signature: django.db.models.fields.IntegerField(default=0, null=True, blank=True))
        db.alter_column('story_story', 'privacy', orm['story.story:privacy'])
    ...
    models = {
        ...
        'geo.mgpxtrack': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 17, 11, 47, 50, 113377)'}),
            ...
            'update_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 17, 11, 47, 50, 113420)'})
        },
        ...
        'story.story': {
            'creation_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2009, 11, 17, 11, 47, 50, 180273)'}),
            ...
            'privacy': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            ...
            'update_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2009, 11, 17, 11, 47, 50, 180307)'})
        },
        'story.storyimage': {
