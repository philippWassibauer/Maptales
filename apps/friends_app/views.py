...
from friends.forms import JoinRequestForm, InviteFriendForm
...
def accept_friendship(request, username, template_name="friends_app/accept_friendship.html"):
    ...
    if request.POST: 
        ...
        invitation = FriendshipInvitation.objects.invitations(from_user=user,
                                                              to_user=request.user)
        return render_to_response(template_name, {"from_user": user,
