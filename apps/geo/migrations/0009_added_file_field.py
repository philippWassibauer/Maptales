...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MGPXTrack.gpx_file'
        db.add_column('geo_mgpxtrack', 'gpx_file', models.FileField(upload_to="gpx_files", blank=True, null=True))
        
    
    def backwards(self, orm):
        
        # Deleting field 'MGPXTrack.gpx_file'
        db.delete_column('geo_mgpxtrack', 'gpx_file')
    ...
    models = {
        ...
        'geo.geogeometrytag': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 16, 11, 20, 16, 762214)'}),
        ...
        'geo.mgpxtrack': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 16, 11, 20, 16, 762991)'}),
            ...
            'update_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 16, 11, 20, 16, 763026)'})
        },
        'geo.mgpxtracksegment': {
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 16, 11, 20, 16, 764661)'}),
            ...
            'update_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 16, 11, 20, 16, 764691)'})
        }
    }
