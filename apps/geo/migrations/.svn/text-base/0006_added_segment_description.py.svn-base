...
class Migration:
    ...
    def forwards(self, orm):
        # Adding field 'MGPXTrackSegment.description'
        db.add_column('geo_mgpxtracksegment', 'description', models.TextField(_('description'), blank=True, null=True))
        db.add_column('geo_mgpxtrack', 'description', models.TextField(_('description'), blank=True, null=True))
        

    def backwards(self, orm):
        # Deleting field 'MGPXTrackSegment.description'
        db.delete_column('geo_mgpxtracksegment', 'description')
        db.delete_column('geo_mgpxtrack', 'description')
    ...
    models = {
        ...
        'geo.geogeometrytag': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 9, 13, 8, 27, 156698)'}),
            'geometry_collection': ('django.contrib.gis.db.models.fields.GeometryCollectionField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
        'geo.mgpxtrack': {
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 9, 13, 8, 27, 157428)'}),
            ...
            'update_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 9, 13, 8, 27, 157458)'})
        },
        'geo.mgpxtracksegment': {
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 9, 13, 8, 27, 158439)'}),
            ...
            'update_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 9, 13, 8, 27, 158468)'})
        }
    }
