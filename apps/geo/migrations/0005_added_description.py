...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2009, 11, 9, 13, 4, 30, 48596)))
        db.alter_column('geo_geogeometrytag', 'created_at', orm['geo.geogeometrytag:created_at'])
        
        # Changing field 'MGPXTrack.creation_date'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2009, 11, 9, 13, 4, 30, 49352)))
        db.alter_column('geo_mgpxtrack', 'creation_date', orm['geo.mgpxtrack:creation_date'])
        
        # Changing field 'MGPXTrack.update_date'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2009, 11, 9, 13, 4, 30, 49394)))
        db.alter_column('geo_mgpxtrack', 'update_date', orm['geo.mgpxtrack:update_date'])
        
        # Changing field 'MGPXTrackSegment.creation_date'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2009, 11, 9, 13, 4, 30, 50356)))
        ...
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2009, 11, 9, 13, 4, 30, 50386)))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'GeoGeometryTag.created_at'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2009, 11, 9, 13, 2, 25, 177987)))
        db.alter_column('geo_geogeometrytag', 'created_at', orm['geo.geogeometrytag:created_at'])
        
        # Changing field 'MGPXTrack.creation_date'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2009, 11, 9, 13, 2, 25, 178759)))
        db.alter_column('geo_mgpxtrack', 'creation_date', orm['geo.mgpxtrack:creation_date'])
        
        # Changing field 'MGPXTrack.update_date'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2009, 11, 9, 13, 2, 25, 178794)))
        db.alter_column('geo_mgpxtrack', 'update_date', orm['geo.mgpxtrack:update_date'])
        
        # Changing field 'MGPXTrackSegment.creation_date'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2009, 11, 9, 13, 2, 25, 179722)))
        db.alter_column('geo_mgpxtracksegment', 'creation_date', orm['geo.mgpxtracksegment:creation_date'])
        
        # Changing field 'MGPXTrackSegment.update_date'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2009, 11, 9, 13, 2, 25, 179752)))
        db.alter_column('geo_mgpxtracksegment', 'update_date', orm['geo.mgpxtracksegment:update_date'])
    ...
    models = {
        ...
        'geo.geogeometrytag': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 9, 13, 4, 30, 48596)'}),
            'geometry_collection': ('django.contrib.gis.db.models.fields.GeometryCollectionField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
        'geo.mgpxtrack': {
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 9, 13, 4, 30, 49352)'}),
            ...
            'update_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 9, 13, 4, 30, 49394)'})
        },
        'geo.mgpxtracksegment': {
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 9, 13, 4, 30, 50356)'}),
            ...
            'update_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 9, 13, 4, 30, 50386)'})
        }
    }
